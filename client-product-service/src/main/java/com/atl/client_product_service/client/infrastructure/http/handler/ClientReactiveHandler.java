package com.atl.client_product_service.client.infrastructure.http.handler;
...
public class ClientReactiveHandler {
    private final IClientReactiveService service;

    public ClientReactiveHandler(IClientReactiveService service) {
